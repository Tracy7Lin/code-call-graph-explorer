...
- [ ] **Step 1: Define the migration scope as Python-structure work, not feature expansion**
- [ ] **Step 2: Name the canonical future module locations**
- [ ] **Step 3: State the compatibility strategy explicitly**
- [ ] **Step 4: Re-read for vague wording and hidden structural decisions**
...
- [ ] **Step 1: Add failing tests that require canonical Python analyzer/indexer paths**
- [ ] **Step 2: Add failing tests that distinguish canonical modules from compatibility wrappers where practical**
- [ ] **Step 3: Keep tests narrow and structural**
- [ ] **Step 4: Run the focused tests and confirm the failure shape**
...
- [ ] **Step 1: Create canonical Python analyzer/indexer package paths**
- [ ] **Step 2: Move implementation modules while keeping imports working**
- [ ] **Step 3: Keep wrapper files thin and obvious**
- [ ] **Step 4: Run focused analyzer/framework tests**
...
- [ ] **Step 1: Document the Python adapter as the canonical extension area**
- [ ] **Step 2: Mark legacy top-level analyzer/indexer paths as transitional if they remain**
- [ ] **Step 3: Keep contributor guidance aligned with the real directory structure**
- [ ] **Step 4: Re-read docs for contradictions with the codebase**
...
- [ ] **Step 1: Run focused tests for framework/governance/analyzer**
- [ ] **Step 2: Run the full quality gate**
- [ ] **Step 3: Review diff scope for accidental structural drift**
- [ ] **Step 4: Commit and push the milestone once the workspace is clean enough**
