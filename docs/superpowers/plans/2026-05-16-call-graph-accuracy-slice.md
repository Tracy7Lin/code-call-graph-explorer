...
- [x] **Step 3: Add minimal fixture files and keep tests focused on alias resolution, ambiguity status, and advisory payload shape**
- [x] **Step 4: Re-run targeted tests and confirm failures now reflect missing implementation**
...
- [x] **Step 1: Add structured edge status and reason fields**
- [x] **Step 2: Extend alias and dotted module resolution**
- [x] **Step 3: Classify ambiguity separately from generic unresolved calls**
- [x] **Step 4: Re-run analyzer tests until green**
...
- [x] **Step 1: Add advisory suggestion model and node detail edge payloads**
- [x] **Step 2: Return deterministic advisory suggestions only for unresolved or ambiguous edges**
- [x] **Step 3: Re-run API tests until green**
...
- [x] **Step 1: Render status-specific styling for resolved, unresolved, and ambiguous edges/nodes**
- [x] **Step 2: Show edge reasons and advisory suggestions in the detail panel**
